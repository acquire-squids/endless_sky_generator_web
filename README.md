...
<sup>1</sup> Python is an easy way to do this with the command `python3 -m http.server 8080`.
  Current working directory must be the `www/` folder.

<sup>2</sup> If you'd rather use the native version via CLI, see [Build Instructions -> Native](#native) .
